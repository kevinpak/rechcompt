import styles from './../styles/components/restore-password.module.scss'
...
const Register = () => {
  ...
  */
  ...
  return (
    <PlainPage title="Restauration de mot de passe" smallTile={true} className="plain-page_body--small">
        ...
        <div className={styles.inner}>
          <form onSubmit={formik.handleSubmit} className={styles.form}>
            ...
            <div className="cpn-form-row cpn-form-row--btns">
              <button className={styles.btn +' cpn-btn cpn-btn__orange'}>Continuer</button>
              <div className={styles.action}>
                <Link href="/login">
                  <a className={styles.link+' '+styles.register}><span>Se connecter</span></a>
                </Link>
                <Link href="/register">
